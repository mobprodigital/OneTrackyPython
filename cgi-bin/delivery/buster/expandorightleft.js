...
function toggle( bannerId, expandTo, width ){
	...
	div			+= '			<a class="ad-hyperlink small"  target="_blank" href="{clickurl}"> ';
	div			+= '				<img class="banner-imgs ad-img-1-id-12" src="{imagePath1}" alt="">';
	div			+= '			</a>';
	div			+= '			<a class="ad-hyperlink large hidden-ad" target="_blank"  href="{clickurl}">';
	div			+= '				<img class="banner-imgs ad-img-1-id-12"  src="{imagePath2}" alt="">';
	div			+= '			</a>';
	div			+= '		</div>';

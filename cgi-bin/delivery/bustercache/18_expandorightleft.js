...
function toggle( bannerId, expandTo, width ){
	...
	div			+= '			<a class="ad-hyperlink small"  target="_blank" href="https://adclick.g.doubleclick.net/pcs/click?xai=akaojssyoeal2kwec4lleb_6dniywzrizmh9hgy1gxwylil2bfftxv7csqp7gfd6ye-p0inubrduwtyylmt44ujhwpdcfuuftcuafttqd428pbdjyjbt6s9rqq3dhhsrrlh_qbdad3ytnn1sby_xn6btmqkmwzxosm6vbtwgm6edmdxwhhsgvlvrdghiwywc5blewlycngocukidlnn9frli0yuudg6typenhiupbhvwstp1x515yg9qe8x_mp3k4xcue-kdz8mp&sai=amfl-yt8sflqwrptesqno8imqlubuxdndrwhmuwebgtgy7ekipotgh62tl1ykp6zk5zfew1ic4stobinidsd20nal8t-tmutfqfohv9eg2bljkcuineav5xntaz4rqjbol4anqlr&sig=cg0arkjszarsndjpzo_peae&urlfix=1&adurl=https://api.onetracky.com/cgi-bin/delivery/core/ckvast.py?zoneid=56&bannerid=18"> ';
	div			+= '				<img class="banner-imgs ad-img-1-id-12" src="https://onetracky.com/pydelivery/media/300x250nyc_HNBCsDv.jpg" alt="">';
	div			+= '			</a>';
	div			+= '			<a class="ad-hyperlink large hidden-ad" target="_blank"  href="https://adclick.g.doubleclick.net/pcs/click?xai=akaojssyoeal2kwec4lleb_6dniywzrizmh9hgy1gxwylil2bfftxv7csqp7gfd6ye-p0inubrduwtyylmt44ujhwpdcfuuftcuafttqd428pbdjyjbt6s9rqq3dhhsrrlh_qbdad3ytnn1sby_xn6btmqkmwzxosm6vbtwgm6edmdxwhhsgvlvrdghiwywc5blewlycngocukidlnn9frli0yuudg6typenhiupbhvwstp1x515yg9qe8x_mp3k4xcue-kdz8mp&sai=amfl-yt8sflqwrptesqno8imqlubuxdndrwhmuwebgtgy7ekipotgh62tl1ykp6zk5zfew1ic4stobinidsd20nal8t-tmutfqfohv9eg2bljkcuineav5xntaz4rqjbol4anqlr&sig=cg0arkjszarsndjpzo_peae&urlfix=1&adurl=https://api.onetracky.com/cgi-bin/delivery/core/ckvast.py?zoneid=56&bannerid=18">';
	...
	div			+= '			</a>';
	div			+= '		</div>';
	div			+= '		<img src="http://api.onetracky.com/cgi-bin/delivery/core/lgimpr.php?bannerid=18&zoneid=56&cb=17c276c8" width="1" height="1" alt="">';
	div			+= '		<img src="https://khulasa-news.com/" width="1" height="1" alt="">';
	div			+= '	</div>';
	div			+= '</div>';

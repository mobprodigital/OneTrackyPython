def getState(countryISO,state):
	...
	# 'IS''02' : "Akureyri"
	# 'IS''03' : "Arnessysla"
	# 'IS''04' : "Austur-Bardastrandarsysla"
	...
	# 'NZ''24' : "Franklin"
	# 'NZ''26' : "Golden Bay"
	# 'NZ''27' : "Great Barrier Island"
	# 'NZ''28' : "Grey"
	# 'NZ''29' : "Hauraki Plains"
	# 'NZ''30' : "Hawera"
	# 'NZ''31' : "Hawke's Bay"
	# 'NZ''32' : "Heathcote"
	# 'NZ''33' : "Hobson"
	...
	# 'ZR''01' : "Bandundu"
	# 'ZR''02' : "Equateur"
	# 'ZR''03' : "Kasai-Occidental"
	# 'ZR''04' : "Kasai-Oriental"
	# 'ZR''05' : "Shaba"
	# 'ZR''06' : "Kinshasa"
	# 'ZR''07' : "Kivu"
	# 'ZR''08' : "Bas-Zaire"
	...
	stateList		= OA_Geo_FIPS[countryISO]
	statesNumKey	= (list(stateList.keys())[list(stateList.values()).index(state)])
	if(statesNumKey):
		return statesNumKey
	else:
	...
	#print(stateList)
	#print(stateCode	= stateList['Bihar'])

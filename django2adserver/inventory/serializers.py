...
from inventory.models import banner_vast_element,rv_ad_zone_assoc
...
class ZonesSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Zones
		fields = '__all__'
class BannervastSerializer(serializers.ModelSerializer):
	
	class Meta:
		model = banner_vast_element
		fields = '__all__'
...
class UsersSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Users
		fields = '__all__'
class rv_ad_zone_assocSerializer(serializers.ModelSerializer):
	
	class Meta:
		model = rv_ad_zone_assoc
		fields = '__all__'
...
class Client_accessSerializer(serializers.ModelSerializer):
	
	class Meta:
		model = Client_access
		fields = '__all__'		

class Publisher_accessSerializer(serializers.ModelSerializer):
	
	class Meta:
		model = Publisher_access
		fields = '__all__'		

class User_assocSerializer(serializers.ModelSerializer):
